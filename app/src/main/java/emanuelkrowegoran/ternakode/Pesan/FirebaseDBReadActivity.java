...
import emanuelkrowegoran.ternakode.Pesan.adapter.AdapterBarangRecyclerView;
...
public class FirebaseDBReadActivity extends AppCompatActivity implements AdapterBarangRecyclerView.FirebaseDataListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
         ...
         */
        database.child("Data Penumpang").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot noteDataSnapshot : dataSnapshot.getChildren()) {
                     ...
                     */
                    Boking barang = noteDataSnapshot.getValue(Boking.class);
    ...
    public static Intent getActIntent(Activity activity){
        return new Intent(activity, HomeDashboard.class);
    }

    @Override
    public void onDeleteData(Boking barang, final int position) {
        /**
         ...
         */
        if(database!=null){
            database.child("Data Penumpang").child(barang.getKey()).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                @Override
